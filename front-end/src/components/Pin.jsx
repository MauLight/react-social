...
const Pin = ({ pin: { postedBy, image, manuscript, _id, save } }) => {
    ...
    return (
        <div className="m-2 my-4">
            <Tilt tiltMaxAngleX={2.5} tiltMaxAngleY={2.5} glareEnable={true} glareMaxOpacity={0.15} glareColor={"black"} glareBorderRadius='10px' >
                <div
                ...
                >
                    {image && (
                        <img className="rounded-lg w-full h-[320px] " src={(urlFor(image).width(250).url())} alt="user-post" />)}
                    {postHovered && (
                        <div
